...
[See here](../../station-alert/config#custom-call-screen) for more info.
...
<Tabs>
	...
	<TabItem value="canadian-french" label="fr-ca (Français Canadien)">
		...
		:::danger
		Valid for SA Version 1.1.0 and below only. Want to help update this translation? [See here](../#want-to-help-us-translate-a-resources)!
		:::
