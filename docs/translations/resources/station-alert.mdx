...
<Tabs>
	...
	<TabItem value="polish" label="Polski" default>
		...
		setr ic_sa_language {
		  ...
		  "CreateANewAlert":                      "Stwóz nowy alert dla dowolnej lokacji.",
		  ...
		  "FirstPersonRequired":                  "To narzędzie jest dotestępne w widoku pierwszoosobowym",
		  ...
		  "NoHiddenPropSelected":                 "Nie zaznaczono propa, celuj w niebieski okrąd",
