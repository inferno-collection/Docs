...
## Want to help us translate a resource?
...
We will provide **$30 USD** in Inferno Collection [Tebex Store](https://store.inferno-collection.com/) credit per complete translation, per resource.  
...
5. Create a Pull Request (or we can do so on your behalf) to update the documentation.
